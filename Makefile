...
resources = $(shell $(GLIB_COMPILE_RESOURCES) --sourcedir=. --generate-dependencies data/jf3.gresource.xml)

CFLAGS = -I./src/lin_eq_solver -O3 -Wall -Wshadow -Wunreachable-code -std=c99
...
jf3-resources.c: data/jf3.gresource.xml data/jf3.glade $(resources)
	$(GLIB_COMPILE_RESOURCES) data/jf3.gresource.xml --target=jf3-resources.c --sourcedir=. --generate-source
